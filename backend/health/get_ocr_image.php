<?php
/**
 * Serves OCR images. Requires auth. Path must be in uploads/ocr/.
 * Same pattern as get_prescription_image.php.
 */
...
if (!preg_match('/^ocr_[a-zA-Z0-9_.-]+\.(jpg|jpeg|png)$/i', $file)) {

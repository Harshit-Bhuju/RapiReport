          ...
          <Card className="border-none shadow-xl shadow-gray-100/50">
            <CardBody className="p-6">
              <div className="flex items-center gap-2 mb-6 text-gray-900 font-black uppercase text-xs tracking-widest">
                ...
                {t("consultantsPage.filters")}
              </div>

              <div className="space-y-6">
                <div>
                  <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">
                    {t("consultantsPage.search")}
                  </label>
                  <div className="relative">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                    <input
                      type="text"
                      placeholder={t("consultantsPage.searchPlaceholder")}
                      value={search}
          ...
          <Card className="border-none shadow-xl shadow-gray-100/50 bg-indigo-600 text-white overflow-hidden relative">
            ...
            <CardBody className="p-6 relative z-10">
              ...
              <p className="text-indigo-100 text-xs font-medium leading-relaxed">
                {t("consultantsPage.verifiedDesc")}
              </p>
            </CardBody>
          </Card>
        </div>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2, 3, 4].map((i) => (
                <Card
                  key={i}
                  className="border-none shadow-xl shadow-gray-100/50 border-gray-100 bg-white animate-pulse">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredDoctors.map((doc) => (
                <Card
                  key={doc.id}
                  className="group border-none shadow-xl shadow-gray-100/50 hover:shadow-2xl hover:shadow-primary-100/50 transition-all duration-300 overflow-hidden bg-white">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-2">
                          <div className="flex items-center gap-1.5 text-xs font-bold text-gray-400">
                            ...
                            {doc.experience_years} {t("consultantsPage.years")}
                          </div>
                          <div className="flex items-center gap-1.5 text-xs font-bold text-gray-400">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-lg font-black text-gray-900">
                          <span className="text-primary-600 text-sm mr-1">
                            Rs.
                          </span>
